...
export default function Card({ name, imageName, contact, email, address, city, state }) {
    return (
        <div className='my-[8px]'>
            <div className='w-[100%] h-[310px] sm:h-[340px] shadow-neutral-300 dark:shadow-neutral-700 shadow-md rounded-md overflow-hidden'>
                ...
                <div className='flex flex-col'>
                    ...
                    <h2 className='text-center py-[8px] text-[20px] shadow-neutral-300 dark:shadow-neutral-700 '> {name} </h2>
